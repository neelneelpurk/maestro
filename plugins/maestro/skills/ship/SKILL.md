...
5. Tell the user the worker is running in the background — they can keep working — and end your turn. When it completes, report the issue → **PR URL**, which now awaits their review (`maestro:in-review`).
