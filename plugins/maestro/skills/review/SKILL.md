---
name: review
description: Review any pull request in the project — multi-dimensional (correctness, security, performance, tests/TDD, coding standards) — and post a native GitHub PR review. Never approves or merges. Use for /maestro:review [pr#].
---
...
6. **Report** a verdict (ship / needs changes) and the key findings. (Locate scripts first: `source .maestro/config.sh; S="${MAESTRO_SCRIPTS:-$(pwd)/.maestro/scripts}"`.)
